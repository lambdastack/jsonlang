        ...
        std::string getName(unsigned from_here, const HeapEntity *e)
        {
            ...
            if (dynamic_cast<const HeapObject*>(e)) {
                ...
                if (func->body == nullptr) {
                    name = jsonlang_builtin_decl(func->builtin).name;
    ...
    class Interpreter {
        ...
        */
        ...
        Interpreter(Allocator *alloc, const StrMap &ext_vars,
                    ...
                    JsonlangImportCallback *import_callback, void *import_callback_context)
                                 ...
                                 const std::vector<Value::Type> params)
        {
            ...
            bad:;
            const std::string &name = jsonlang_builtin_decl(builtin).name;
            std::stringstream ss;
                                 ...
                                 const std::string &indent)
        {
            ...
            switch (scratch.t) {
                ...
                case Value::DOUBLE:
                ss << jsonlang_unparse_number(scratch.v.d);
                break;
                ...
                case Value::STRING: {
                    ...
                    ss << jsonlang_unparse_escape(str);
                }
                break;
            }
            return ss.str();
...
std::string jsonlang_vm_execute(Allocator *alloc, const AST *ast,
                               const StrMap &ext_vars,
                               unsigned max_stack, double gc_min_objects,
                               double gc_growth_trigger,
                               JsonlangImportCallback *import_callback, void *ctx,
                               bool string_output)
{
...
StrMap jsonlang_vm_execute_multi(Allocator *alloc, const AST *ast, const StrMap &ext_vars,
                                unsigned max_stack, double gc_min_objects, double gc_growth_trigger,
                                JsonlangImportCallback *import_callback, void *ctx,
                                bool string_output)
{
